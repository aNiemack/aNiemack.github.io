...
const mesa1: SystemFile = {
  ...
  content: [
    ...
    data, including adding features to view realtime telemetry data\n and notifications and generally making viewing important data more intuitive. (Django, Python)`,
